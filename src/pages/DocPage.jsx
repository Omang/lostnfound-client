        ...
        <div className=" grid  mt-6 bg-opacity border rounded-2xl -mx-8 py-2 px-8">
            ...
            <div className="relative">
                ...
                <div>
                    {doc.doc_images?.[0] && (
                        <div>
                            <img className="aspect-square object-cover" src={'http://localhost:5000/uploads/'+doc.doc_images?.[0]} />
                        </div>
                    )}
                </div>
                <div className="grid gap-2"> {doc.doc_images?.[1] && (
                        <img className="aspect-square object-cover" src={'http://localhost:5000/uploads/'+doc.doc_images?.[1]} />
                    )}</div>
